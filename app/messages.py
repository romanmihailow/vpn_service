...
# === Объединённая post-config инструкция (одно сообщение вместо двух) ===
...
# === Приветственное сообщение AI-помощника (smalltalk / onboarding) ===
AI_ASSISTANT_ONBOARDING_TEXT = (
    "Я помощник MaxNet VPN 🤖\n\n"
    "Могу помочь подключить VPN, проверить подписку, отправить конфиг или ответить на вопросы.\n\n"
    "Например, напишите:\n\n"
    "• «вышли конфиг»\n"
    "• «проверь подписку»\n"
    "• «как подключиться»\n"
    "• «сколько стоит»\n"
    "• «мой id»\n\n"
    "Если нужна помощь человека — я позову оператора."
)
...
# === Тарифы / подписка (то же, что в /subscription; используется в action_pricing_info и cmd_subscription) ===
PRICING_HEADER = "💳 <b>Тарифы MaxNet VPN</b>\n"
...
# === Опрос причины отказа (no handshake survey) ===
SURVEY_ANSWER_CONFIRMATION = "Спасибо за ответ! Это поможет нам улучшить сервис."
SURVEY_ANSWER_CONFIRMATION_SETUP_HELP = (
    "Спасибо за ответ! Это поможет нам улучшить сервис.\n\n"
    "Если захочешь, я могу помочь с подключением."
)
SURVEY_ANSWER_ALREADY_SAVED = "Ответ уже сохранён, спасибо."

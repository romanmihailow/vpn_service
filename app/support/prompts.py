...
- Если запрашиваемой информации нет в FAQ — НЕ придумывай ответ. Ответь, что точной информации нет, и предложи обратиться в поддержку. Пример: «У меня нет точной информации по этому вопросу. Лучше уточнить в поддержке.» Не выдумывай детали про серверы, инфраструктуру, локации или внутренние политики."""

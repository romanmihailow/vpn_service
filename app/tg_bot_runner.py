...
AGREEMENT_TEXT = (
    ...
    "2.1. Сервис предназначен для обеспечения шифрованного соединения при доступе к ресурсам "
    "сети Интернет для личного и законного использования.\n"
    "2.2. Сервис не предназначен для совершения противоправных действий и использования "
    "в нарушение законодательства твоей страны и/или страны размещения серверов.\n"
    "2.3. Сервис не предназначен специально для обеспечения анонимности или сокрытия личности "
    "пользователя и не гарантирует отсутствие какой-либо фильтрации или ограничений со стороны "
    "третьих лиц.\n\n"
    ...
    "6.4. Мы не гарантируем обеспечение анонимности пользователя и не несем ответственность за "
    "последствия, связанные с попытками использовать сервис для её достижения.\n\n"
